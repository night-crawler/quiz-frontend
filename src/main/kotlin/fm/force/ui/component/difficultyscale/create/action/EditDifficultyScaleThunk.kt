package fm.force.ui.component.difficultyscale.edit.action
...
class EditDifficultyScaleThunk(private val editDTO: DifficultyScaleEditDTO) : ThunkForm() {
    override suspend fun run(
        ...
        return checkedRun(
            start = { dispatch(EditDifficultyScaleStart(editDTO)) },
            ...
            dispatch(EditDifficultyScaleSuccess(difficultyScale))
            dispatch(Noop())
        }
    }
}
